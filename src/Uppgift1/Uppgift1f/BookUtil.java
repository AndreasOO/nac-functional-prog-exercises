...
public class BookUtil {
    ...
    public BookUtil() {
        this.books = List.of(
                ...
                new Book("ÄÄÄÄDreams of Tomorrow", "Emily White", "Science Fiction", "Yellow", 7, "Alice", true),
                new Book("ÅÅÅÅJourney's End", "Michael Brown", "Fantasy", "Purple", 6, "Bob", true),
                new Book("ÖÖÖÖThe Silent Observer", "John Doe", "Thriller", "Black", 8, "Library", false),
